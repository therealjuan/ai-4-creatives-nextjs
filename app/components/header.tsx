        ...
        <div className="w-[100vw] mx-auto absolute py-[4vh] max-lg:relative">
            <div className="flex flex-wrap justify-between items-center z-9 max-w-[95vw] w-full relative mx-auto">
                ...
                <ul className={`text-standard max-lg:text-2xl max-lg:block flex max-lg:absolute z-5 right-0 items-center max-lg:bg-black max-lg:text-white w-auto gap-6 pl-7 top-6 
                            max-lg:left-[-2.5vw] max-lg:w-[100vw] max-lg:h-[100vh] max-lg:pt-24 max-lg:h-full z-[98] max-lg:pl-8 min-lg:py-0 transition-all ${isMenuOpen ? 'max-lg:top-[-4vh]' : 'max-lg:top-[-105vh]'}`}>
