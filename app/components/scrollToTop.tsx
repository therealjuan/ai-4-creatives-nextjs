...
export const ScrollToTop = () => {
    ...
    return (
        <div>
            <a id="scrollToTop" ref={btnRef} href="#top" className="w-10 h-10 fixed bottom-4 right-4 max-lg:right-8 max-lg:bottom-6 float-right mr-0 transition-all duration-500 translate-y-[200%]">
