        ...
        <div className="w-full backdrop-blur sticky z-50 top-0 py-[3vh]">
            <div className="text-standard max-w-[95vw] mx-auto mx-auto flex flex-row flex-wrap w-full" id="categories">
                ...
                {data.map((item) => (
                        ...
                        `, item.key === selectedCategory ? "bg-green-500 text-black hover:bg-green-500 hover:text-black" : "text-green-500 hover:bg-green-500 hover:text-black")}>
                            ...
                            {locale === 'es' && item.nameEs}
                                ...
                                <button 
                    onClick={() => scrollToElement("newsletter")} className="text-green-500 text-[1.8vh] border-b-1 mx-1 mb-2 border-b border-green-500 hover:text-black hover:border-black">{t("subscribe")} {t("forUpdates")}</button>            
                ...
                <div className="flex flex-column gap-6 lg:hidden w-full ">
                    ...
                    <button 
                    onClick={() => scrollToElement("newsletter")} className="bg-transparent text-standard-2x text-green-500 border-b-1 mx-1 mb-2 border-b border-green-500 mt-2 hover:text-black hover:border-black">{t("subscribe")}</button>
