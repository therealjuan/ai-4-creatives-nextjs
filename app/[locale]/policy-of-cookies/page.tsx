...
const PolicyOfCookiesPage = () => {
    ...
    return ( 
        <div className="px-8">
            <h1 className="mb-8 font-black tracking-tight leading-tight pb-6 text-8xl lg:text-[12vh] dark:text-white w-full" style={{ backgroundPosition: `${mousePosition.x}px ${mousePosition.y}px` }}>{t("headline")}</h1>
            <div className="grid grid-cols-8 mb-0">
                <div className="col-span-5 text-xl lg:text-[1.6vh] leading-8">
                    <p className="text-2xl lg:text-[2vh] mb-2">{t("lastUpdated-1")}</p>
                    <p className="text-2xl lg:text-[2vh] mb-6">{t("lastUpdated-2")}</p>
                    ...
                    <h4 className="font-bold text-2xl lg:text-[2vh] leading-tight mb-4">{t("h4-1")}</h4>
                    ...
                    <h4 className="font-bold text-2xl lg:text-[2vh] leading-tight mb-4">Analytics</h4>
                    <Table className="mb-8">
                        <TableHeader>
                            <TableRow>
                                <TableHead className="font-bold">{t("tableHead-1")}</TableHead>
                    ...
                    <h4 className="font-bold text-2xl lg:text-[2vh] leading-tight mb-4 text-black">{t("h4-2")}</h4>
