      ...
      <div className="px-8">
            ...
            <div className="grid grid-cols-8 mb-0">
                <div className="col-span-5 text-xl leading-8">
                    ...
                    <li>
                    <p className="mb-6"><div dangerouslySetInnerHTML={{__html: t.raw('p4')}} ></div></p>
                    </li>
                    <li>
                    <p className="mb-6"><div dangerouslySetInnerHTML={{__html: t.raw('p5')}} ></div></p>
                    </li>
                    <li>
                    <p className="mb-6"><div dangerouslySetInnerHTML={{__html: t.raw('p6')}} ></div></p>
                    </li>
                    <li>
                    <p className="mb-6"><div dangerouslySetInnerHTML={{__html: t.raw('p7')}} ></div></p>
                    </li>
                    <li>
                    <p className="mb-6"><div dangerouslySetInnerHTML={{__html: t.raw('p8')}} ></div></p>
                    </li>
                    <li>
                    <p className="mb-6"><div dangerouslySetInnerHTML={{__html: t.raw('p9')}} ></div> <a href="https://www.freeprivacypolicy.com/free-terms-and-conditions-generator/" target="_blank">Free Terms and Conditions Generator</a></p>
                    </li>
                    <li>
                    ...
                    <li>
                    <p className="mb-6"><div dangerouslySetInnerHTML={{__html: t.raw('p13')}} ></div></p>
                    </li>
                    </ul>
                    ...
                    <p className="mb-6">{t("p15")}</p>
                    <p className="mb-6">{t("p16")}</p>
                    <p className="mb-6">{t("p17")}</p>
                    ...
                    <p className="mb-6">{t("p19")}</p>
                    <p className="mb-6">{t("p20")}</p>
