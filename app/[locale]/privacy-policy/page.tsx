        ...
        <div className="px-8">
            ...
            <div className="grid grid-cols-8 mb-0">
                <div className="col-span-5 text-xl leading-8">
                    <p className="mb-6 text-standard-2xl">{t("p1a")} https://aiforcreativ.es, {t("pb")}</p>
                    <p className="mb-6 text-standard-2xl">{t("p2")}<a className="border-b-2 border-black hover:border-green-500 hover:text-green-500" href="https://www.termsfeed.com/privacy-policy-generator/">Privacy Policy Generator</a>.</p>
                    ...
                    <p className="mb-8 text-standard-2xl">{t("p4")}</p>
                    ...
                    <p className="mb-8 text-standard-2xl">{t("p5")}<a className="border-b-2 border-black hover:border-green-500 hover:text-green-500" href="https://www.termsfeed.com/privacy-policy-generator/">https://policies.google.com/technologies/ads</a></p>
                    ...
                    <p className="mb-8 text-standard-2xl">{t("p6")}</p>
                    ...
                    <p className="mb-8 text-standard-2xl">{t("p9")}</p>
                    ...
                    <p className="mb-6 text-standard-2xl">{t("p10")}</p>
                    <p className="mb-8 text-standard-2xl">{t("p11")}</p>
                    ...
                    <p className="mb-6 text-standard-2xl">{t("p12")}</p>
                    <p className="mb-8 text-standard-2xl">{t("p13")}</p>
                    ...
                    <p className="mb-8 text-standard-2xl">{t("p14")}</p>
                    ...
                    <p className="mb-8 text-standard-2xl">{t("p15")}</p>
                </div>
            </div>
        </div>
     );
